...
const StudentSignup = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (passwordRef.current.value !== confirmPassword) newErrors.confirmPassword = 'Passwords do not match';
    ...
    <div className="body">
      <div className="container-signup">
        ...
        <div className="right-section">
          ...
          <p className="login-link">Already have an account? <Link to="/StudentLogin">Login.</Link></p>
        </div>
      </div>
    </div>
  );
