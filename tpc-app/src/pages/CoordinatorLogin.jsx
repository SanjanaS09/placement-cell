                ...
                <div className="right-section">
                    ...
                    <form id="loginForm" onSubmit={handleSubmit}>
                        <div className="role-tabs">
                            ...
                            <Link to="/CoordinatorLogin" className="tab active">Coordinator</Link>
                        </div>
                        <input
                            type="email"
                            id="email"
                        ...
                        <p className="signup-link">Don't have an account? <Link to="/CoordinatorSignup">Sign up now.</Link></p>
                    </form>
                </div>
            </div>
        </div>
